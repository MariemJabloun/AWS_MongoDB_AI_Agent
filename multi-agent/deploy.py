...
The code is built on Amazon Bedrock Agent Core Starter Toolkit and requires valid AWS credentials.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--entry_point", type=str, help="Entry point file for the agent"
    )
    parser.add_argument(
        "--local_build",
        action="store_true",
        help="Use local build (only for arm64 platforms)",
    )
